...
public class SwitchView extends View {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        if (isCanVisibleDrawing) {
            ...
            bCenterX = (bRight + bLeft) / 2;
            bCenterY = (bBottom + bTop) / 2;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        paint.setColor(isOn ? colorPrimary : Color.rgb(54, 54, 54));
        ...
        // 圆
//    SweepGradient sg = new SweepGradient(bWidth / 2,bWidth/2,new int[]{getResources().getColor(R.color.white),getResources().getColor(R.color.black)},null);

        SweepGradient mShader = new SweepGradient(bCenterX, bCenterY, new int[]{
                Color.WHITE,
