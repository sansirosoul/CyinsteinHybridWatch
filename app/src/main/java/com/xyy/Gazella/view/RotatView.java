...
public class RotatView extends View {
    ...
    public void setRotatDrawable(BitmapDrawable drawable) {
        ...
        rotatBitmap = SomeUtills.getZoomImage(rotatBitmap,rotatBitmap.getWidth()*0.95,rotatBitmap.getHeight()*0.95);
        initSize();
        postInvalidate();
    }
    ...
    /**
     * ͨ通过此方法来控制旋转度数，如果超过360，让它求余，防止，该值过大造成越界
     * 
     * @param added
     */
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN: {
                ...
                current_degree2 = detaDegree(o_x, o_y, down_x, down_y);
                vRecord.reset();
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                float dete2 = degree - current_degree2;
                ...
                addDegree(dete);
                if(dete2>10){
                    current_degree2=degree;
                    changeTimeListener.ChangeTimeListener(true);
                }else if(dete2<-10){
                    current_degree2=degree;
                    changeTimeListener.ChangeTimeListener(false);
                }
...
//        rotatBitmap.recycle();
    ...
    public void setChangeTimeListener(ChangeTimeListener listener){
        this.changeTimeListener=listener;
    }

     public interface ChangeTimeListener{
         void ChangeTimeListener(boolean isClockwise);
    }
}
