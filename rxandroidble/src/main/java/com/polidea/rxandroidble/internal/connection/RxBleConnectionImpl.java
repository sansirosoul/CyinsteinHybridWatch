...
public class RxBleConnectionImpl implements RxBleConnection {
    ...
    static final UUID CLIENT_WRITE_CONFIG_UUID = UUID.fromString("6e400002-b5a3-f393-e0a9-e50e24dcca9e");
    static final UUID CLIENT_NOTIFY_CONFIG_UUID = UUID.fromString("6e400003-b5a3-f393-e0a9-e50e24dcca9e");
