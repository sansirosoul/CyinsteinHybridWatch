...
public class BasePickerView {
    ...
    private  int gravityTop=Gravity.TOP;
...
//        contentContainer.startAnimation(outAnim);
    ...
    public Animation getTopInAnimation() {
        int res = PickerViewAnimateUtil.getAnimationResource(this.gravityTop, true);
        return AnimationUtils.loadAnimation(context, res);
    }
    /***
     *   从中间显示
     */
    public Animation getTopOutAnimation() {
        int res = PickerViewAnimateUtil.getAnimationResource(this.gravityTop, false);
        return AnimationUtils.loadAnimation(context, res);
    }
